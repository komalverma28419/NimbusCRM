...
<div
  className="
    ...
    inset-0
    -z-20
    bg-[radial-gradient(circle_at_top,rgba(139,92,246,0.18),transparent_35%),radial-gradient(circle_at_bottom_right,rgba(59,130,246,0.12),transparent_35%),linear-gradient(to_bottom,#ffffff,#f8fafc,#ffffff)]
  "
